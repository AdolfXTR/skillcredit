...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      // ✅ FIX: fetch ALL ratings where this user was rated (no role filter)
      // RLS must allow SELECT USING (true) for this to work
      ...
      <nav style={{ background:"rgba(255,255,255,0.96)", backdropFilter:"blur(16px)", borderBottom:"1px solid #e8e2d9", padding:"0 32px", height:56, display:"flex", alignItems:"center", justifyContent:"space-between", position:"sticky", top:0, zIndex:100 }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          <div style={{ position:"relative" }} onClick={e => { e.stopPropagation(); setShowMenu(m => !m); }}>
            <div style={{ width:36, height:36, borderRadius:"50%", background:levelInfo.color, color:"#fff", fontSize:12, fontWeight:900, display:"flex", alignItems:"center", justifyContent:"center", cursor:"pointer", boxShadow:`0 0 0 2px white, 0 0 0 3.5px ${levelInfo.color}` }}>
              {initials}
            </div>
            {showMenu && (
      ...
      <div style={{ maxWidth:1200, margin:"0 auto", padding:"28px" }}>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:12 }}>
              ...
              <div>
                <div style={{ fontSize:14, fontWeight:800, color:"#92400e" }}>
                  {pendingSessions} pending session request{pendingSessions > 1 ? "s" : ""} waiting!
                </div>
                <div style={{ fontSize:12, color:"#b45309" }}>Accept or decline in My Sessions</div>
              </div>
            </div>
            <div style={{ background:"#f59e0b", color:"#fff", padding:"8px 18px", borderRadius:10, fontSize:13, fontWeight:800, whiteSpace:"nowrap", flexShrink:0 }}>
              Review Now →
            </div>
          </a>
        )}
        ...
        <div className="card" style={{ padding:"26px 30px", marginBottom:16, display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:20, animation:"fadeUp 0.4s ease", position:"relative", overflow:"hidden" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:16 }}>
            <div style={{ position:"relative" }}>
              <div style={{ width:64, height:64, borderRadius:"50%", background:`linear-gradient(135deg,${levelInfo.color},${levelInfo.color}88)`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:22, fontWeight:900, color:"#fff", boxShadow:`0 8px 24px ${levelInfo.color}44` }}>
                {initials}
              </div>
            ...
            <div>
              <div style={{ fontSize:11, color:"#aaa", fontWeight:700, letterSpacing:"0.07em", textTransform:"uppercase", marginBottom:3 }}>
                {greeting} {badge.emoji}
              </div>
              <h1 style={{ fontFamily:"'Fraunces',serif", fontSize:24, fontWeight:900, color:"#111", lineHeight:1.1, marginBottom:6 }}>
                {profile.full_name}
              </h1>
              <div style={{ display:"flex", alignItems:"center", gap:7, flexWrap:"wrap" }}>
                <span style={{ fontSize:12, color:"#aaa" }}>@{profile.username}</span>
                <span style={{ fontSize:11, fontWeight:800, padding:"3px 10px", borderRadius:999, background:`${levelInfo.color}15`, color:levelInfo.color }}>
                  {LEVEL_ICONS[levelInfo.name]} {levelInfo.name}
                </span>
                <span style={{ fontSize:11, fontWeight:800, padding:"3px 10px", borderRadius:999, background:badge.bg, color:badge.color, border:`1px solid ${badge.color}22` }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(5,1fr)", gap:12, marginBottom:16, animation:"fadeUp 0.4s 0.07s ease both" }}>
          ...
          <a href="/ratings" className="card stat-card" style={{ padding:"18px 20px", display:"block" }}>
            ...
            <div style={{ fontFamily:"'Fraunces',serif", fontSize:32, fontWeight:900, color:avgRating !== null ? "#f59e0b" : "#d1cec8", lineHeight:1 }}>
              {ratingDisplay}
            </div>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            ...
            <div className="card" style={{ padding:"20px" }}>
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:14 }}>
                ...
                <span style={{ fontSize:11, fontWeight:800, padding:"4px 12px", borderRadius:999, background:badge.bg, color:badge.color, border:`1px solid ${badge.color}22` }}>
                  {badge.emoji} {badge.name}
                </span>
              </div>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:8, marginBottom:14 }}>
                {[
                  ...
                  <div key={s.label} style={{ background:"#f8f7f4", borderRadius:10, padding:"10px 8px", textAlign:"center" }}>
                    ...
                    <div style={{ fontFamily:"'Fraunces',serif", fontSize:17, fontWeight:900, color:s.label === "Rating" && avgRating === null ? "#ccc" : "#1a1a1a" }}>
                      {s.val}
                    </div>
              ...
              {avgRating === null && (
                <a href="/sessions" style={{ display:"flex", alignItems:"center", gap:8, background:"#fffbeb", border:"1.5px solid #fde68a", borderRadius:12, padding:"10px 14px", marginBottom:14, fontSize:12, color:"#b45309", fontWeight:700 }}>
                  <span>⭐</span>
                  <span>Complete a session to get your first review!</span>
            ...
            <div className="card" style={{ padding:"20px" }}>
              ...
              <div style={{ background:"linear-gradient(135deg,#fffbeb,#fef3c7)", borderRadius:14, padding:"14px 16px", marginBottom:14, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
                <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                  ...
                  <div>
                    <div style={{ fontFamily:"'Fraunces',serif", fontSize:26, fontWeight:900, color:"#b45309", lineHeight:1 }}>
                      {rep}<span style={{ fontSize:14, color:"#daa520" }}>/100</span>
                    </div>
