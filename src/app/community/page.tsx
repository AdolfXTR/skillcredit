    ...
    <div>
      {preview ? (
        <div style={{ position: "relative", display: "inline-block" }}>
          ...
          {uploading && <div style={{ position: "absolute", inset: 0, background: "rgba(255,255,255,0.85)", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center" }}><div style={{ width: 20, height: 20, border: "2px solid #2d6a4f", borderTopColor: "transparent", borderRadius: "50%", animation: "spin 0.7s linear infinite" }} /></div>}
          {done && <div style={{ position: "absolute", bottom: 8, right: 8, background: "#2d6a4f", color: "#fff", fontSize: 10, fontWeight: 800, padding: "3px 9px", borderRadius: 20 }}>✓</div>}
